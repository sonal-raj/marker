...
function showUpgradeNotification(html) {
  if (document.querySelector('#marker-upgrade-notification-content')) {
    return;
  }
  ...
  var optionsLink = document.querySelector('#marker-upgrade-notification-link');
  optionsLink.addEventListener('click', function() {
    clearUpgradeNotification(true);
    // Allow the default action
  });

  var closeLink = document.querySelector('#marker-upgrade-notification-close');
...
function clearUpgradeNotification(notifyBackgroundScript) {
  ...
  var elem = document.querySelector('#marker-upgrade-notification-content');
  if (elem) {
