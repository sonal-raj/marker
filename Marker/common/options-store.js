...
if (typeof(Utils) === 'undefined' && typeof(Components) !== 'undefined') {
  Components.utils.import('resource://marker_common/utils.js');
}
...
var MozillaOptionsStore = {
  ...
  _sendRequest: function(data, callback) { // analogue of chrome.extension.sendMessage
    ...
    try {
      ...
      Utils.consoleLog('marker: failing back to content script preferences code');
      Utils.consoleLog(ex);
...
var SafariOptionsStore = {
  ...
  // The default values or URLs for our various options.
  defaults: {
    'main-css': {'__defaultFromFile__': (typeof(safari) !== 'undefined' ? safari.extension.baseURI : '')+'marker/src/common/default.css', '__mimeType__': 'text/css'},
    'syntax-css': {'__defaultFromFile__': (typeof(safari) !== 'undefined' ? safari.extension.baseURI : '')+'marker/src/common/highlightjs/styles/github.css', '__mimeType__': 'text/css'},
    'math-enabled': false,
    'math-value': '<img src="https://chart.googleapis.com/chart?cht=tx&chl={urlmathcode}" alt="{mathcode}">',
    'hotkey': { shiftKey: false, ctrlKey: true, altKey: true, key: 'M' },
    'forgot-to-render-check-enabled': false
